...
<html>
    ...
    <body>
        ...
        <main class="tools">
            ...
            <div class="tools__div tools-common">
                <div class="tools-common-actions">
                    ...
                    <div style="display:none;" class="tools-common__div tools-common__div_next">
                        <button style="display:none;" class="tools-common__button tools-common___button_lessOftenUsed tools__button_back switcher">
                            <svg class="tools-common__svg" viewBox="0 0 1024 1024">
                                <path d="M768 903.232l-50.432 56.768L256 512l461.568-448 50.432 56.768L364.928 512z"/>
                            </svg>
                        </button>
                        <button style="display:none;" class="tools-common__button tools-common___button_lessOftenUsed tools__button_deleteList">
                            <svg class="tools-common__svg" viewBox="0 0 1024 1024">
                        ...
                        <button style="display:none;" class="tools-common__button tools-common___button_lessOftenUsed tools__button_shareList">
                            <svg class="tools-common__svg" viewBox="0 0 32 32">
                        ...
                        <button style="display:none;" class="tools-common__button tools-common___button_lessOftenUsed tools__button_editList">
            ...
            <div class="tools__div tools-listsControl">
                ...
                <div class="tools-listsControl__div tools-listsControl-cath">
                    <button class="tools-listsControl-cath__button tools__button_selectCathegory">
                    ...
                    <button class="tools-listsControl-cath__button tools_button__selectSubcathegory">
            ...
            <div class="tools__div tools-actionsArea">
                <div class="tools-actionsArea-editing">
                    <div class="tools-actionsArea-editing__div">
                        <p class="tools-actionsArea-editing__p tools__p_nestingLevel">3</p>
                    </div>
                ...
                <div class="tools-actionsArea-confirmation">
                    ...
                    <button style="display:none;" class="tools-actionsArea-confirmation__button tools__button_saveCathChanges">
                        <svg class="tools-actionsArea-confirmation__svg" viewBox="0 0 24 24">
                    ...
                    <button style="display:none;" class="tools-actionsArea-confirmation__button tools__button_deleteCath">
            ...
            <div class="tools__div tools-selectionArea">
                <div class="tools-selectionArea-cathegoryItem">
                    <button class="tools-selectionArea-cathegoryItem__button tools__button_drag">
                        <svg class="tools-selectionArea-cathegoryItem__svg" viewBox="0 0 24 24" fill="none">
                    ...
                    <pre class="tools-selectionArea-cathegoryItem__pre">Наименование группы</pre>
                    <p class="tools-selectionArea-cathegoryItem__p">8</p>
                </div>
                <div class="tools-selectionArea-cathegoryItem">
                    <button class="tools-selectionArea-cathegoryItem__button tools__button_drag">
                        <svg class="tools-selectionArea-cathegoryItem__svg" viewBox="0 0 24 24" fill="none">
        ...
        <script type="module" src="/src/js/view/tools/selectionArea/tools_selectionArea.js"></script>
    </body>
</html>