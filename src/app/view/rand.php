...
<html>
    ...
    <body>
        ...
        <main class="tools">
            ...
            <div class="tools__div tools-actionsBar">
                <div class="tools-actionsBar-editing">
                    <div class="tools-actionsBar-editing__div">
                ...
                <div class="tools-actionsBar-confirmation">
                    <button class="tools-actionsBar-confirmation__button tools__button_addNewCath">
                    ...
                    <button class="tools-actionsBar-confirmation__button tools__button_createNesting">
                        <svg class="tools-actionsBar-confirmation__svg" viewBox="0 0 16 16" >
