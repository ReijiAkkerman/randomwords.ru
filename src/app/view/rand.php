...
<html>
    ...
    <body>
        ...
        <main class="tools">
            ...
            <div class="tools__div tools-listsControl">
                <div class="tools-listsControl__div tools-listsControl-group">
                    <button class="tools-listsControl-group__button tools-listsControl-group__button_personalLists">
                        ...
                        <p style="display:none;" class="tools-listsControl-group__p">Личные списки</p>
                    </button>
                    <button class="tools-listsControl-group__button tools-listsControl-group__button_friendLists">
                        <svg class="tools-listsControl-group__svg" viewBox="0 0 32 32">
                        ...
                        <p style="display:none;" class="tools-listsControl-group__p">Списки друзей</p>
                    </button>
                    <button class="tools-listsControl-group__button tools-listsControl-group__button_groupLists">
                        ...
                        <p style="display:none;" class="tools-listsControl-group__p">Групповые списки</p>
                    </button>
                </div>
        ...
        <script type="module" src="/src/js/view/listsControl__group.js"></script>
    </body>
</html>