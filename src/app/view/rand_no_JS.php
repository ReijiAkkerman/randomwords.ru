...
<html>
    ...
    <body>
        ...
        <main class="tools">
            ...
            <div style="display:none;" class="tools__div tools-sectionSelectionArea">
                ...
                <div class="tools-sectionSelectionArea-sectionsList">
                    ...
                    <div class="tools-sectionSelectionArea-sectionsList__div">
                        ...
                        <button class="tools-sectionSelectionArea-sectionsList-sectionItem-increaseNestingLevel__button">
                            <svg class="tools-sectionSelectionArea-sectionsList-sectionItem-increaseNestingLevel__svg" viewBox="0 0 24 24" style="opacity: 1;">
                                <path d="M4 16L3.46967 15.4697C3.32902 15.6103 3.25 15.8011 3.25 16H4ZM17 3L17.5303 2.46967C17.2374 2.17678 16.7626 2.17678 16.4697 2.46967L17 3ZM21 7L21.5303 7.53033C21.8232 7.23744 21.8232 6.76256 21.5303 6.46967L21 7ZM8 20V20.75C8.19891 20.75 8.38968 20.671 8.53033 20.5303L8 20ZM4 20H3.25C3.25 20.4142 3.58579 20.75 4 20.75V20ZM12 19.25C11.5858 19.25 11.25 19.5858 11.25 20C11.25 20.4142 11.5858 20.75 12 20.75V19.25ZM20.5 20.75C20.9142 20.75 21.25 20.4142 21.25 20C21.25 19.5858 20.9142 19.25 20.5 19.25V20.75ZM4.53033 16.5303L17.5303 3.53033L16.4697 2.46967L3.46967 15.4697L4.53033 16.5303ZM16.4697 3.53033L20.4697 7.53033L21.5303 6.46967L17.5303 2.46967L16.4697 3.53033ZM20.4697 6.46967L7.46967 19.4697L8.53033 20.5303L21.5303 7.53033L20.4697 6.46967ZM8 19.25H4V20.75H8V19.25ZM4.75 20V16H3.25V20H4.75ZM13.4697 6.53033L17.4697 10.5303L18.5303 9.46967L14.5303 5.46967L13.4697 6.53033ZM12 20.75H20.5V19.25H12V20.75Z"></path>
                            </svg>
                        </button>
                    </div>
            ...
            <div class="tools__div tools-lists">
                <div class="tools-lists-listTypeArea" data-type="combined">
                    <pre class="tools-lists-header">Объединенные списки</pre>
                </div>
                <div class="tools-lists-listTypeArea" data-type="split">
                    <pre class="tools-lists-header">Разделенные списки</pre>
                </div>
                <div class="tools-lists-listTypeArea" data-type="hard">
                    <pre class="tools-lists-header">Списки трудных слов</pre>
                </div>
                <div class="tools-lists-listTypeArea" data-type="simple">
                    <pre class="tools-lists-header">Списки слов</pre>
                    <button class="tools-lists-listItem">Список слов</button>
                    <button class="tools-lists-listItem">Список слов</button>
                    <button class="tools-lists-listItem">Список слов</button>
                    <button class="tools-lists-listItem">Список слов</button>
                    <button class="tools-lists-listItem">Список слов</button>
            ...
            <div class="tools__div tools-quickAccessBar">
                <div class="tools-quickAccessBar-languageSwitcher">
                    <button class="tools-quickAccessBar-languageSwitcher__button">jp</button>
                    <button class="tools-quickAccessBar-languageSwitcher__button">mm</button>
                </div>
                <div class="tools-quickAccessBar-viewMode">
                    <label class="tools-quickAccessBar-viewMode__label" for="">
                        <svg class="tools-quickAccessBar-viewMode__svg" viewBox="0 0 64 64" enable-background="new 0 0 64 64">
                    ...
                    <label class="tools-quickAccessBar-viewMode__label" for="">
                        <svg class="tools-quickAccessBar-viewMode__svg svg-stroke" viewBox="0 0 48 48">
                ...
                <div class="tools-quickAccessBar-additionalOptions">
                    ...
                    <label class="tools-quickAccessBar-additionalOptions__label" for="">
                        <svg class="tools-quickAccessBar-additionalOptions__svg" viewBox="0 0 512 512">
