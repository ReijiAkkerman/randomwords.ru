    ...
    <body>
        ...
        <main class="tools">
            ...
            <div class="tools__div tools-lists">
                <div style="display:none;" class="tools-lists-listTypeArea" data-type="combined">
                    <pre class="tools-lists-header">Объединенные списки</pre>
                </div>
                <div style="display:none;" class="tools-lists-listTypeArea" data-type="split">
                    <pre class="tools-lists-header">Разделенные списки</pre>
                </div>
                <div style="display:none;" class="tools-lists-listTypeArea" data-type="hard">
            ...
            <div class="tools__div tools-quickAccessBar">
                ...
                <div class="tools-quickAccessBar-viewMode">
                    <button class="tools-quickAccessBar-viewMode__button">
