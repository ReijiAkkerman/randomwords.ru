            ...
            <div class="tools__div tools-listsControl">
                ...
                <div class="tools-listsControl__div tools-listsControl-workingGroup">
                    <button class="tools-listsControl-workingGroup-item">
                        <svg class="tools-listsControl-group__svg" viewBox="0 0 32 32" style="opacity: 1;">
                    ...
                    <button class="tools-listsControl-workingGroup-item">
                        <svg class="svg-stroke tools-listsControl-group__svg" viewBox="0 0 32 32" style="opacity: 1;">
