...
<html>
    ...
    <body>
        ...
        <section class="mainWindow entries" style="display:none;">
        ...
        <section class="mainWindow funds">
        ...
        <section class="switcher">
            ...
            <button class="switcher__button switcher-settings">
