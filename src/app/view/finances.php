...
<html>
    ...
    <body>
        ...
        <section class="switcher">
            <button class="switcher__button switcher-funds" data-section="funds" style="background-color:#0000;border-top-color:#0000">
                <svg class="switcher__svg" viewBox="0 0 16 16">
                    <path d="M4,13H2V11H4Zm10-2H6v2h8ZM4,7H2V9H4ZM14,7H6V9h8ZM4,3H2V5H4ZM14,3H6V5h8Z"/>
                </svg>
            </button>
            <button class="switcher__button switcher-selectedFund" data-section="entries">
            ...
            <button class="switcher__button switcher-settings" data-section="settings">
