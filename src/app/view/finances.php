    ...
    <body>
        <main class="info">
            <div class="info-header">
                <pre class="info-header__pre actions"></pre>
                <pre class="info-header__pre stats"></pre>
                <pre class="info-header__pre settings"></pre>
            </div>
            <div class="info-mainPart">
                ...
                <div class="info-mainPart-settings"></div>
            </div>
            <div class="info-options">
                
            </div>
        </main>
        <section class="cathegories">
            <button class="cathegories__button cathegories_actions">
            ...
            <button class="cathegories__button cathgories_stats">
                <svg viewBox="-0.5 0 32 32" preserveAspectRatio="xMidYMid">
            ...
            <button class=" cathegories__button cathegories_settings">
                <svg viewBox="0 0 512 512">
